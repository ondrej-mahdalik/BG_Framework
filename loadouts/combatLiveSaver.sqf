...
for "_i" from 1 to 7 do {player addItemToBackpack "ACE_personalAidKit";};
for "_i" from 1 to 4 do {player addItemToBackpack "ACE_tourniquet";};
player addItemToBackpack "ACE_UAVBattery";
player addItemToBackpack "ACE_surgicalKit";
for "_i" from 1 to 7 do {player addItemToBackpack "ACE_morphine";};
for "_i" from 1 to 7 do {player addItemToBackpack "ACE_epinephrine";};
for "_i" from 1 to 7 do {player addItemToBackpack "ACE_bloodIV_500";};
